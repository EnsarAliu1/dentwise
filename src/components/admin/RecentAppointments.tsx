import { useGetAppintments, useUpdateAppointmentStatus } from "@/hooks/use-appointment";
...
function RecentAppointments() {
  const { data: appointments = [] } = useGetAppintments();
                  ...
                  <TableCell>
                    <div>
                      <div className="font-medium">
                        {`${appointment.user.firstName ?? ""} ${appointment.user.lastName ?? ""}`.trim() || "Unknown Patient"}
                      </div>
