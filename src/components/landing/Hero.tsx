...
function Hero() {
  return (
    <section className='relative min-h-screen lg:h-screen flex items-center overflow-hidden pt-24 pb-12 lg:py-0'>
      {/* GRID BG */}
